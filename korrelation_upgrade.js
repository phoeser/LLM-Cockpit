...
(function () {
  ...
  function peecBiasWarn(){
    return '<div style="background:#fff4f4;border:1px solid #f3c6c6;border-left:4px solid #dc0028;border-radius:8px;padding:10px 12px;margin-bottom:10px;font-size:11.5px;color:#7a1420;line-height:1.5">'+
      '<b>\u26a0 Peec-SoV ist hier kein neutrales Marktranking.</b> Das Peec-Projekt \u201eERGO Germany\u201c ist ERGOs eigenes Monitoring: <b>132 von 614 Prompts (21\u202f%) nennen ERGO ausdr\u00fccklich</b> (\u201eIst ERGO vertrauensw\u00fcrdig f\u00fcr \u2026?\u201c), <b>kein einziger nennt einen Wettbewerber</b>. Dadurch liegt ERGOs Peec-SoV mit Branding-Prompts bei <b>~27,5\u202f%</b> (Platz\u202f1); <b>neutral</b> (nur markenfreie Prompts) nur <b>~8,2\u202f%</b> \u2014 Platz\u202f3 hinter Allianz (~19,5\u202f%) und HUK (~12,8\u202f%), Faktor <b>~3,4\u00d7</b>. Als echtes Marktranking gilt die neutrale Ansicht bzw. der eigene Crawl. Peec-branded hier = \u201eSichtbarkeit, wenn gezielt \u00fcber ERGO gefragt wird\u201c.'+
    '</div>';
  }
  /* ---------- Ueber-/Unterperformer-Scatter (Peec-26-Markenmittel, 26 Punkte) ---------- */
  ...
  function block3Skeleton(){
    return '<div style="margin:16px 0 6px"><div style="font-size:14px;font-weight:700;color:#1a1a2e">3 · Quellen-Vergleich: Peec (fuehrend) vs. eigener Crawl</div>'+
      '<div style="font-size:11.5px;color:#9ca3af;margin:1px 0 10px">Zwei unabhaengige Messungen derselben Sache. Niveau-Unterschiede kommen von unterschiedlichen Engines/Methoden (Peec 5 Engines inkl. Web, eigener Crawl 3), NICHT von der Markenzahl (26 vs. 25 — nahezu gleich) — entscheidend ist die <b>Rang-Konvergenz</b> je Thema.</div>'+
      peecBiasWarn()+
  ...
  function fillBlock3(){
    ...
    loadPeecCells().then(function(cells){
      ...
      box.innerHTML=b3Btns()+'<div style="display:flex;justify-content:space-between;flex-wrap:wrap;gap:8px;align-items:flex-start;margin-bottom:8px">'+
        ...
        '<div style="font-size:11px;color:#9ca3af;margin-top:8px">Beschraenkt auf die vier Kernmarken ERGO, Allianz, HUK-Coburg, AXA (Entscheidung Paul, 31.07.2026). Zellenformat: Peec / eigener Crawl in %. Rang-ρ ≥ 0,8 (gruen) = beide Quellen sehen dieselbe Reihenfolge der vier Marken — bei n=4 grob, aber direkt lesbar. Niveau-Unterschiede folgen aus unterschiedlichen Engines/Methoden (Peec 5 inkl. Web, Crawl 3), nicht aus der Markenzahl (26 vs. 25). Kanal: '+b3ModeLbl()+' · Peec-Export siehe data/peec_cells.csv (zeitraum-Spalte).</div>';
      b3Wire(box);
    });
  }
