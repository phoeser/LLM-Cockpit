...
(function () {
  ...
  function build(){
    ...
    box.innerHTML =
      ...
      + '</div>'
      + '<style>.mlScrollTab thead th{position:sticky;top:0;z-index:2}</style>'
      + '<div style="overflow:auto;max-height:640px;border:1px solid #eef0f3;border-radius:8px"><table class="w-full text-sm mlScrollTab"><thead><tr class="bg-ergo-dark text-white">'
